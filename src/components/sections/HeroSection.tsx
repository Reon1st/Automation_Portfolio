        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div ref={heroElements.ref as React.RefObject<HTMLDivElement>} className="space-y-6 will-animate">
            <div className="space-y-4">
              <h1 className="text-3xl lg:text-4xl font-bold tracking-tight text-foreground will-animate">
                {SITE_CONFIG.name}
              </h1>
              <h2 className="text-lg lg:text-xl text-primary font-semibold will-animate">
                {SITE_CONFIG.title}
              </h2>
              <div className="flex items-center gap-2 text-muted-foreground mb-4 will-animate">
              ...
              <div className="flex flex-wrap items-center gap-4 will-animate">
                <Button
                  ...
                  className="text-sm font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
                >
            ...
            {/* Social Links */}
            <div className="flex flex-wrap gap-2 will-animate">
          ...
          <div className="flex justify-center lg:justify-end will-animate">
